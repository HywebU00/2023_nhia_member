...
var fsBtn = document.querySelector(".functionSearchBtn");
var fsBlock = document.querySelector(".functionSearchBlock");

    // 監聽按鈕的點擊事件
    fsBtn.addEventListener('click', function() {
      // 檢查容器的高度是否為 0
      if (fsBlock.offsetHeight === 0) {
        // 設置容器的高度為內容的高度
        fsBlock.style.height = fsBlock.scrollHeight + 'px';
      } else {
        // 將容器的高度設置為 0
        fsBlock.style.height = 0;
      }
    });